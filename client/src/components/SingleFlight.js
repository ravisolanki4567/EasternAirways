    ...
    if (this.props.location.pathname === "/editDep") {
      ...
      this.setState(
        ...
        () =>
          console.log(
            "heck",
            this.state.searchFlight,
            sessionStorage.getItem("cabinSearch")
          )
      );
    } else {
      this.setState(
    ...
    return (
      <>
        <div className="single-card">
          <div style={{ width: "70%", marginTop: "5px" }}>
            <div className="booking-flight">
              ...
              <a
                href="#"
                onClick={this.handleModalShow.bind(this, "showModal")}
              >
                Details {">"}
              </a>
            </div>
        ...
        <TripDetailsModal
          ...
          parentFunc={() => this.handleModalShow("showModal")}
          ...
          baggage={
            flight[sessionStorage.getItem("cabinSearch")].BaggageAllowance
          }
        />
      </>
    );
