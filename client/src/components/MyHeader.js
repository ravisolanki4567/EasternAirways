...
class MyHeader extends Component {
  ...
  handleClickCabin = (event) => {
    this.setState({
      anchorElCabin: event.currentTarget,
      openCabin: true,
    });
  };
  ...
  handleMenuItemClick = (event, index) => {
    ...
    this.setState(
      ...
      () => {
        console.log(
          "this is the state",
          this.state[event.target.getAttribute("name")]
        );
      }
    );
  ...
  render() {
    ...
    return (
      <div className="admin-header logo-buttons-search">
          ...
          <div className="header-buttons-container">
            {localStorage.getItem("token") ? (
              <>
                ...
                <ProfileDropdown
                  ParentRedirect={this.onLogoutRedirect.bind(this)}
        ...
        <div
          className="flex-col"
          style={{ gap: "0", alignItems: "center", marginTop: "10px" }}
        >
          <div
          ...
          >
            ...
            >
              <div>
                <Button
                  ...
                  style={{ color: "white" }}
                >
                  {Number(childCount) + Number(adultCount) === 1
                    ? Number(childCount) + Number(adultCount) + " Passenger"
            ...
            <div
              className="flex-row "
              style={{ gap: " 0.5rem", width: "100%", alignItems: "stretch" }}
            >
              <Form.Group style={{ flexGrow: 1 }} className="mb-2">
                <Typeahead
                  ...
                  labelKey="name"
                  onChange={(arr) => {
                    this.setDepartureSelections(arr);
                  }}
                  options={deptOptions}
              ...
              >
                <Form.Control
                  ...
                  min={
                    deptDate
                      ? new Date(deptDate).toISOString().substring(0, 10)
                      : ""
                  }
                  name="retDate"
                  onChange={this.handleSearch.bind(this)}
              ...
              <div>
                <Button
                  ...
                  onClick={this.flightSearch.bind(this)}
                  variant="contained"
                >
                  <SearchIcon style={{ fontSize: "large" }} /> Search
                </Button>
              </div>
            </div>
