...
export default class Trip extends Component {
  ...
  render() {
    const { deptFlight, arrFlight, deptCabin, arrCabin, adults, children } =
      this.props;
    const deptPrice =
      deptFlight[deptCabin]["PriceAdult"] * adults +
      deptFlight[deptCabin]["PriceChild"] * children;
    const retPrice =
      arrFlight[arrCabin]["PriceAdult"] * adults +
      arrFlight[arrCabin]["PriceChild"] * children;
    ...
    return (
      <>
        <div className="booking-card ">
          <div style={{ width: "70%", marginTop: "5px" }}>
            <div className="trip-flight">
              ...
              <a
                href="#"
                onClick={this.handleModalShow.bind(this, "showModaldept")}
              >
                details {">"}
              </a>
            </div>
            <div className="trip-flight">
              ...
              <a
                href="#"
                onClick={this.handleModalShow.bind(this, "showModalarr")}
              >
                details {">"}
              </a>
            </div>
        ...
        <TripDetailsModal
          show={this.state.showModaldept}
          parentFunc={() => this.handleModalShow("showModaldept")}
          fNum={deptFlight.FlightNumber}
          depDate={deptFlight.DepartureDate}
          arrDate={deptFlight.ArrivalDate}
          depTime={deptFlight.DepartureTime}
          arrTime={deptFlight.ArrivalTime}
          duration={deptFlight.TripDuration}
          depAirport={deptFlight.DepartureAirport}
          arrAirport={deptFlight.ArrivalAirport}
          cabinClass={deptCabin}
          baggage={deptFlight[deptCabin].BaggageAllowance}
        />

        <TripDetailsModal
          show={this.state.showModalarr}
          parentFunc={() => this.handleModalShow("showModalarr")}
          fNum={arrFlight.FlightNumber}
          depDate={arrFlight.DepartureDate}
          arrDate={arrFlight.ArrivalDate}
          depTime={arrFlight.DepartureTime}
          arrTime={arrFlight.ArrivalTime}
          duration={arrFlight.TripDuration}
          depAirport={arrFlight.DepartureAirport}
          arrAirport={arrFlight.ArrivalAirport}
          cabinClass={arrCabin}
          baggage={arrFlight[arrCabin].BaggageAllowance}
        />
      </>
    );
  }
