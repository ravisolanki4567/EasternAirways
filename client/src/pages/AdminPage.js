...
export default class AdminPage extends Component {
    ...
    switch (e.target.name) {
      case "flightSearch":
        if (this.state.filteredArr.length != 0) {
          this.setState({
            filteredArr: this.state.filteredArr.filter((f) =>
              f.FlightNumber.toString().includes(value)
            ),
          });
        } else {
          this.setState({
            filteredArr: this.state.flightArr.filter((f) =>
              f.FlightNumber.toString().includes(value)
            ),
          });
        }
      ...
      case "arrivalSearch":
        if (this.state.filteredArr.length != 0) {
          this.setState({
            filteredArr: this.state.filteredArr.filter((f) =>
              f.ArrivalTime.toString().includes(value)
            ),
          });
        } else {
          this.setState({
      ...
      case "departureSearch":
        if (this.state.filteredArr.length != 0) {
          this.setState({
            filteredArr: this.state.filteredArr.filter((f) =>
              f.DepartureTime.toString().includes(value)
            ),
          });
        } else {
          this.setState({
      ...
      case "arrDateSearch":
        if (this.state.filteredArr.length != 0) {
          this.setState({
            filteredArr: this.state.filteredArr.filter((f) =>
              f.ArrivalDate.toString().includes(value)
            ),
          });
        } else {
          this.setState({
      ...
      case "depDateSearch":
        if (this.state.filteredArr.length != 0) {
          this.setState({
            filteredArr: this.state.filteredArr.filter((f) =>
              f.DepartureDate.toString().includes(value)
            ),
          });
        } else {
          this.setState({
      ...
      case "terminalSearch":
        if (this.state.filteredArr.length != 0) {
          this.setState({
            filteredArr: this.state.filteredArr.filter((f) =>
              f.Terminal.toString().includes(value)
            ),
          });
        } else {
          this.setState({
  ...
  filterSearch(value) {
    ...
    if (flightSearch != "") {
      this.setState({
        filteredArr: this.filteredArr.filter((f) =>
          f.FlightNumber.toString().includes(value)
        ),
      });
    }
